...
public class DisplayTitlesResultSet {
	 ...
	 final String DATABASE_URL = "jdbc:oracle:thin:@oracle1.centennialcollege.ca:1521:SQLD";  
	  // final String DATABASE_URL = "jdbc:oracle:thin:@199.212.26.208:1521:SQLD";
	   final String SELECT_QUERY =                            
	      "SELECT ISBN, Title FROM titles WHERE EditionNumber BETWEEN 6 AND 10 ORDER BY ISBN";
	   ...
	   try (                                                        
         ...
         System.out.printf("Titles Table Result Set from Books Database:%n%n");
